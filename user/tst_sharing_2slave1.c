...
void _main(void)
{
	...
	if (*y != 20)
		panic("1Get(): Shared Variable is not created or got correctly");
	...
	if (*x != 10)
		panic("2Get(): Shared Variable is not created or got correctly");

	*z = *x + *y;
	if (*z != 30)
		panic("3Get(): Shared Variable is not created or got correctly");
