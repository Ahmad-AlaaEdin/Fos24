...
void *sys_sbrk(int increment)
{
	...
	// calls sys func to inc or dec program memory

	// returns pntr to new mem location after resizing
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
	...
	// call sys func to free mem starting at (virtual_address) with given (size).
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
	...
	// call sys func to allocate mem starting at (virtual_address) with given (size)
